...
# 1. Remove the background from the section
content = content.replace(
    '<section id="locations" class="section" style="background: rgba(146, 199, 215, 0.2); border-radius: 40px; margin-bottom: 60px; max-width: 1100px;">',
    '<section id="locations" class="section">'
)

# 2. Revert the cards to crisp white backgrounds with borders on hover (or just default nice shadow)
new_locations = """<h2 class="section-title" style="margin-bottom: 20px;">Explore Our Locations</h2>
    ...
    <div class="features-grid">
      ...
      <a href="crawford.html" style="text-decoration: none; color: inherit; display: block; height: 100%;">
        <div class="feature-card" style="height: 100%; border: 4px solid transparent; background: white; border-radius: 40px; transition: all 0.3s; padding: 50px 30px;">
